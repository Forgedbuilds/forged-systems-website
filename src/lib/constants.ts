...
export const AGENTS = [
  {
    name: 'PATCH',
    role: 'Outreach Agent',
    capability: 'Executes LinkedIn outreach sequences. Identifies prospects, sends personalised connection requests, and follows up with value-led messaging on autopilot.',
  },
  {
    name: 'WIDOW',
    role: 'Inbound Lead Agent',
    capability: 'Captures every form submission and inbound inquiry. Qualifies in real time, routes high-value leads instantly, and schedules discovery calls without human input.',
  },
  {
    name: 'KAREN',
    role: 'Pipeline Auditor',
    capability: 'Runs a full pipeline audit at 6am daily. Flags stalled deals, identifies at-risk clients, and delivers a priority action list before the workday begins.',
  },
  {
    name: 'RHODEY',
    role: 'Sales Intelligence Agent',
    capability: 'Pre-call research delivered in 90 seconds. Company background, buying signals, competitor weaknesses, and suggested positioning — before every meeting.',
  },
  {
    name: 'PEPPER',
    role: 'Client Delivery Agent',
    capability: 'Monitors every active project for delivery risk. Sends client updates, escalates blockers, and ensures nothing slips through the cracks post-sale.',
  },
  {
    name: 'VAULT',
    role: 'Financial Operations Agent',
    capability: 'Tracks revenue, automates invoice generation, monitors retainer health, and delivers weekly financial summaries with cash flow projections.',
  },
];
